...
<div v-for="item in familyData" :key="item" class="relative">
  ...
  <img class="w-full" :src="item.hero_image" alt="A mesmerizing hero image featuring a graceful mermaid, enchanting viewers with her ethereal beauty beneath the shimmering waves">
