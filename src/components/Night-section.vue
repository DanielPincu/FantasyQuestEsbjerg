<template>
  <div v-if="nightData">
   <div v-for="(item, index) in nightData" :key="index">
     <h1 class="md:text-5xl text-xl container mx-auto text-yellow-500 text-gradient text-center pt-20">
     ...
     <a target="_blank" href="https://www.universe.com/events/fantasy-quest-aftenquest-tickets-2PCHR4">
       <BuyButton />
     </a>
