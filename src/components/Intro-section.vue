<template>
    <div class="text-3xl italic text-justify tracking-tighter flex flex-col items-center md:pt-5 pt-44 justify-center container mx-auto">
        ...
        <h1 class="text-center text-[60px] pt-24 pb-10">Fantasy Quest Esbjerg</h1>
